...
const NomoBanner = () => {
  return (
    <div
      className="rounded-xl px-6 lg:mx-20 py-10 md:py-16 md:px-12 text-white m-8 bg-cover bg-center"
      style={{
        backgroundImage: 'url("./article-bg.webp")', // <- Replace with your image path
      }}
    >
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold mb-4">
              Can't find your preferred <span className='text-blue-500'>payment method?</span>
            </h2>
            <p className="text-base md:text-lg mb-6 text-white/90">
              Contact us and let us know which payment method you'd like us to add next!
            </p>
            <button className="bg-white hover:bg-green-600 text-blue-500 font-medium px-5 py-3 rounded-md transition">
              Contact Us
            </button>
          </div>
