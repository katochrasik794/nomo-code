  ...
  Powered by AI
        ...
        <h1 className="text-4xl lg:text-7xl font-bold leading-tight">
         Navigate{" "}
          Markets,
          <br></br>
          <span className="text-purple-600">Maximize Gains</span>
        </h1>

        {/* Description */}
        <p className="text-gray-600 text-xl">
          Begin your trading journey today with stocks, indices, and more on <span className="text-blue-600">nomo</span>
        </p>
      ...
      {/* RIGHT SIDE */}
      <div className="w-full h-[450px] mt-12 lg:mt-0 flex justify-center relative">
        <img
          src="/iphone.avif"
