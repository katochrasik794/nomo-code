    ...
    <section className="w-full bg-gradient-to-b from-white to-[#f3f6ff] py-16 px-4 md:px-10 flex flex-col items-center text-center">
      ...
      <div className="mb-10">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
          Why <span className="text-blue-600">AI</span> changes the game
        </h2>
        <p className="text-gray-600 max-w-2xl mt-3">
          nomo AI Index is a smart, living portfolio — a constantly optimized
          selection of trades, built by AI trained on the strategies of the top
          managers on nomo.
        </p>
      </div>
